...
RResult<std::shared_ptr<RTheme>>
RThemeManager::create_theme(const std::string &name) {
...
void RThemeManager::load_default_theme(RTheme &theme) {
  ...
  style.Colors[ImGuiCol_WindowBg] = ImVec4(0.13f, 0.14f, 0.17f, 0.40f);
