...
//  ImGuiPlatformIO interface. 2025-02-24: [Docking] Added undocumented
//  ImGui_ImplDX11_SetSwapChainDescs() to configure swap chain creation for
//  secondary viewports. 2025-01-06: DirectX11: Expose VertexConstantBuffer in
...
static void ImGui_ImplDX11_CreateWindow(ImGuiViewport* viewport) {
  ...
  // a higher-level handle (e.g. GLFWWindow*, SDL's WindowID). Some backends
